...
void ge25519_multi_scalarmult_vartime(ge25519_p3* r, ge25519_p3* p, sc25519* s, const unsigned long long npoints)
{
    ...
    for (i = 0;; i++) {
        ...
        if ((s[max1].v[3] == 0) || (sc25519_iszero_vartime(&s[max2])))
            break;
    ...
    for (;; i++) {
        heap_get2max(pos, &max1, &max2, s);
        if ((s[max1].v[2] == 0) || (sc25519_iszero_vartime(&s[max2])))
            break;
        sc25519_sub_nored(&s[max1], &s[max1], &s[max2]);
        ge25519_add(&p[max2], &p[max2], &p[max1]);
    ...
    for (;; i++) {
        heap_get2max(pos, &max1, &max2, s);
        if ((s[max1].v[1] == 0) || (sc25519_iszero_vartime(&s[max2])))
            break;
        sc25519_sub_nored(&s[max1], &s[max1], &s[max2]);
        ge25519_add(&p[max2], &p[max2], &p[max1]);
    ...
    for (;; i++) {
        heap_get2max(pos, &max1, &max2, s);
        if (sc25519_iszero_vartime(&s[max2]))
            break;
        sc25519_sub_nored(&s[max1], &s[max1], &s[max2]);
        ge25519_add(&p[max2], &p[max2], &p[max1]);
