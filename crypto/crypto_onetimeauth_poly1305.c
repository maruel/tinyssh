...
int crypto_onetimeauth_poly1305_tinynacl(unsigned char* o, const unsigned char* m, unsigned long long n, const unsigned char* k)
{
    ...
    while ((long long)n > 0) {
        ...
        /* (partial) h %= p */
        c = (crypto_uint32)(d0 >> 26);
        h0 = (crypto_uint32)d0 & 0x3ffffff;
        d1 += c;
        c = (crypto_uint32)(d1 >> 26);
        h1 = (crypto_uint32)d1 & 0x3ffffff;
        d2 += c;
        c = (crypto_uint32)(d2 >> 26);
        h2 = (crypto_uint32)d2 & 0x3ffffff;
        d3 += c;
        c = (crypto_uint32)(d3 >> 26);
        h3 = (crypto_uint32)d3 & 0x3ffffff;
        d4 += c;
        c = (crypto_uint32)(d4 >> 26);
        h4 = (crypto_uint32)d4 & 0x3ffffff;
        h0 += c * 5;
        c = (h0 >> 26);
        h0 = h0 & 0x3ffffff;
        h1 += c;
    ...
    /* mac = (h + pad) % (2^128) */
    f = (crypto_uint64)h0 + uint32_unpack(k + 16);
    h0 = (crypto_uint32)f;
    f = (crypto_uint64)h1 + uint32_unpack(k + 20) + (f >> 32);
    h1 = (crypto_uint32)f;
    f = (crypto_uint64)h2 + uint32_unpack(k + 24) + (f >> 32);
    h2 = (crypto_uint32)f;
    f = (crypto_uint64)h3 + uint32_unpack(k + 28) + (f >> 32);
    h3 = (crypto_uint32)f;
