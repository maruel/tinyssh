    ...
    struct buf* b)
{
    ...
    if (!b || b->len < 0 || b->len > 1073741824 || b->alloc <= 0 || b->alloc > 1073741824 || !b->buf)
        bug_inval_(fn, line);
    ...
    struct buf* b, long long len)
{
    ...
    if (!b || b->len < 0 || b->len > 1073741824 || b->alloc <= 0 || b->alloc > 1073741824 || !b->buf || len < 0 || len > 1073741824)
        bug_inval_(fn, line);
    ...
    struct buf* b, const unsigned char* x, long long len)
{
    ...
    if (!b || b->len < 0 || b->len > 1073741824 || b->alloc <= 0 || b->alloc > 1073741824 || !b->buf || !x || len < 0 || len > 1073741824)
        bug_inval_(fn, line);
    ...
    struct buf* b, const unsigned char* x, long long len)
{
    ...
    if (!buf_putnum32_(fn, line, b, len))
        return 0;
